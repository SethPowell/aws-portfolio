                ...
                <div class="flip-card">
                    <div class="flip-card-inner">
                        <div class="flip-card-front">
                            ...
                            <img className="rom-img" src="https://creazilla-store.fra1.digitaloceanspaces.com/emojis/45719/ring-emoji-clipart-md.png" />
                        </div>
                        <div className="flip-card-back">
                ...
                <div class="flip-card">
                    <div class="flip-card-inner">
                        <div class="flip-card-front">
                            ...
                            <img className="rod-ball" src="https://clipartix.com/wp-content/uploads/2016/05/Clipart-house-images-free-clipart-images-3.png" />
                        </div>
                        <div className="flip-card-back">
